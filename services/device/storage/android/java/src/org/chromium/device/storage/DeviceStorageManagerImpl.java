...
import org.chromium.device.mojom.DeviceStorageResultCode;
import org.chromium.device.mojom.DeviceStorageStorageInfo;
...
public class DeviceStorageManagerImpl implements DeviceStorageManager {
	 ...
	 */
	public static class Factory implements InterfaceFactory<DeviceStorageManager> {
			public Factory() {
			}

			@Override
			public DeviceStorageManager createImpl() {
					return new DeviceStorageManagerImpl(ContextUtils.getApplicationContext());
			}
	}
