...
import org.chromium.device.mojom.DeviceGalleryResultCode;
import org.chromium.device.mojom.MojoDeviceGalleryFindOptions;
import org.chromium.device.mojom.MojoDeviceGalleryMediaObject;
import org.chromium.device.mojom.MojoDeviceGalleryMediaContent;
...
public class DeviceGalleryManagerImpl implements DeviceGalleryManager {
	 ...
	 */
	public static class Factory implements InterfaceFactory<DeviceGalleryManager> {
			public Factory() {
			}

			@Override
			public DeviceGalleryManager createImpl() {
					return new DeviceGalleryManagerImpl(ContextUtils.getApplicationContext());
			}
	}
}
