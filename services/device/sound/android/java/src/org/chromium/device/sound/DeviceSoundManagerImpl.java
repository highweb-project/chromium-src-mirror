...
import org.chromium.device.mojom.DeviceSoundResultCode;
import org.chromium.device.mojom.DeviceSoundVolume;
...
public class DeviceSoundManagerImpl implements DeviceSoundManager {
	 ...
	 */
	public static class Factory implements InterfaceFactory<DeviceSoundManager> {
			public Factory() {
			}

			@Override
			public DeviceSoundManager createImpl() {
					return new DeviceSoundManagerImpl(ContextUtils.getApplicationContext());
			}
	}
