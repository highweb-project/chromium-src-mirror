...
import org.chromium.device.mojom.CalendarResultCode;
import org.chromium.device.mojom.CalendarCalendarInfo;
...
public class CalendarManagerImpl implements CalendarManager {
	...
	public static CalendarResultCode s_CalendarDeviceApiDeleteEvent(Context context, String id) {
		...
		if (!checkPermission(context)) {
			...
			code.resultCode = code_list.NOT_ENABLED_PERMISSION;
			return code;
		}
	 ...
	 */
	public static class Factory implements InterfaceFactory<CalendarManager> {
			public Factory() {
			}

			@Override
			public CalendarManager createImpl() {
					return new CalendarManagerImpl(ContextUtils.getApplicationContext());
			}
	}
