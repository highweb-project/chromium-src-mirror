...
import org.chromium.device.mojom.ContactAddress;
import org.chromium.device.mojom.ContactManager;
import org.chromium.device.mojom.ContactName;
import org.chromium.device.mojom.ContactObject;
...
public class ContactManagerImpl implements ContactManager, ContactConstantsAndroid, OnContactResultListener {
     ...
     */
    public static class Factory implements InterfaceFactory<ContactManager> {
        public Factory() {
        }

        @Override
        public ContactManager createImpl() {
            return new ContactManagerImpl(ContextUtils.getApplicationContext());
        }
    }
}
