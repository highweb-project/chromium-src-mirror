...
import org.chromium.device.mojom.MessageObject;
...
public class MessagingManagerImpl implements MessagingManager, MessagingConstantsAndroid, OnMessagingResultListener {
     ...
     */
    public static class Factory implements InterfaceFactory<MessagingManager> {
        public Factory() {
        }

        @Override
        public MessagingManager createImpl() {
            return new MessagingManagerImpl(ContextUtils.getApplicationContext());
        }
    }
}
