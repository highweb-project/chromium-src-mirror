...
bool OpenCLProxy::Send(int routeId, cl_point event_key, unsigned callback_key, unsigned object_type) {
  return channel_->Send(new OpenCLChannelMsg_Callback((int)routeId, event_key, callback_key, object_type));
}
