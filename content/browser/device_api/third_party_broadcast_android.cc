...
static void ReceiveAndroidBroadcast(JNIEnv* env, const JavaParamRef<jclass>& jcaller, const JavaParamRef<jstring>& j_action, jint process_id_, jint routing_id_) {
