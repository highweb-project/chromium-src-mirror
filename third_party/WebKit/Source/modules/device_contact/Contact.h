...
private:
	...
	void OnContactResultsWithFindOption(int32_t requestId, uint32_t error, WTF::Optional<WTF::Vector<device::blink::ContactObjectPtr>> result);
	void OnContactResultsWithObject(int32_t requestId, uint32_t error, WTF::Optional<WTF::Vector<device::blink::ContactObjectPtr>> result);
