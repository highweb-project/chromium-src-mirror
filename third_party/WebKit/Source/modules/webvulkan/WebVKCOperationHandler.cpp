...
void WebVKCOperationHandler::startHandling()
{
	...
	if(!mIsShared) {
		...
		mSharedData = WTF::WrapUnique(Platform::Current()->getSharedMemoryForWebVKC(kMaxBufferSize));
		...
		mSharedOperation = WTF::WrapUnique(Platform::Current()->getSharedMemoryForWebVKC(sizeof(BaseVKCOperationData)));
		...
		mSharedResult = WTF::WrapUnique(Platform::Current()->getSharedMemoryForWebVKC(sizeof(BaseVKCResultData)));
