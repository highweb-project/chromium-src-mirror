...
namespace gpu {
	...
	VKCResult webvkc_createShaderModuleWithUrl(GpuChannelHost*, VKCPoint&, std::string&, VKCPoint*);
	VKCResult webvkc_createShaderModuleWithSource(GpuChannelHost*, VKCPoint&, std::string&, VKCPoint*);
