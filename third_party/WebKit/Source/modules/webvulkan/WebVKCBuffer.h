...
public:
	...
	VKCResult readBuffer(VKCuint index, VKCuint bufferByteSize, NotShared<DOMArrayBufferView> hostPtr, ExceptionState& ec);
	VKCResult writeBuffer(VKCuint index, VKCuint bufferByteSize, NotShared<DOMArrayBufferView> hostPtr, ExceptionState& ec);
