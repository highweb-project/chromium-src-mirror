...
static const char* const exceptionNamesVK[] = {
    "VK_NOT_READY",
    "VK_TIMEOUT",
...
static const char* const exceptionDescriptionsVK[] = {
    "VK_NOT_READY",
    "VK_TIMEOUT",
    "VK_ERROR_OUT_OF_HOST_MEMORY",
    "VK_ERROR_OUT_OF_DEVICE_MEMORY",
...
String WebVKCException::getErrorName(int code) {
	...
	VKCLOG(INFO) << "string : " << String(exceptionNamesVK[index]);
	return String(exceptionNamesVK[index]);
}
...
String WebVKCException::getErrorMessage(int code) {
	...
	return String(exceptionDescriptionsVK[index]);
}
