...
import org.chromium.device.DeviceGalleryResultCode;
import org.chromium.device.MojoDeviceGalleryFindOptions;
import org.chromium.device.MojoDeviceGalleryMediaObject;
import org.chromium.device.MojoDeviceGalleryMediaContent;
...
public class DeviceGalleryManagerImpl implements DeviceGalleryManager {
	...
	public static class Factory implements InterfaceFactory<DeviceGalleryManager> {
			...
			public DeviceGalleryManager createImpl() {
					return new DeviceGalleryManagerImpl(mContext);
			}
	}
}
