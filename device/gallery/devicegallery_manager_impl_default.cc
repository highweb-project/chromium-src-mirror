...
class DeviceGalleryManagerEmptyImpl : public DeviceGalleryManager {
 public:
  ...
  explicit DeviceGalleryManagerEmptyImpl(DeviceGalleryManagerRequest request)
 ...
 private:
  ...
  mojo::StrongBindingPtr<DeviceGalleryManager> binding_;
};

}  // namespace

// static
void DeviceGalleryManagerImpl::Create(DeviceGalleryManagerRequest request) {
