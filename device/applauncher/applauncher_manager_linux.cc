...
AppLauncherManagerLinux::AppLauncherManagerLinux(mojo::InterfaceRequest<AppLauncherManager> request):binding_(this, std::move(request)) {
}
...
void AppLauncherManagerLinux::LaunchApp(
  const mojo::String& packageName, const mojo::String& activityName, const LaunchAppCallback& callback) {
...
void AppLauncherManagerLinux::RemoveApp(
  const mojo::String& packageName, const RemoveAppCallback& callback) {
  AppLauncher_ResultCodePtr result = AppLauncher_ResultCode::New();
  result->resultCode = int32_t(device::applauncher_code_list::NOT_SUPPORT_API);
...
void AppLauncherManagerLinux::GetAppList(const mojo::String& mimeType, const GetAppListCallback& callback) {
  AppLauncher_ResultCodePtr result = AppLauncher_ResultCode::New();
  result->resultCode = int32_t(device::applauncher_code_list::NOT_SUPPORT_API);
  ...
  if (fileList->size() > 0) {
    for(size_t listIndex = 0; listIndex < fileList->size(); listIndex++) {
      ...
      if (appInfo != nullptr && !appInfo->name.is_null()) {
...
void AppLauncherManagerLinux::GetApplicationInfo(
  const mojo::String& packageName, const int32_t flags, const GetApplicationInfoCallback& callback) {
  AppLauncher_ResultCodePtr result = AppLauncher_ResultCode::New();
  result->resultCode = int32_t(device::applauncher_code_list::NOT_SUPPORT_API);
