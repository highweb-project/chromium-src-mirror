...
import org.chromium.device.AppLauncherResultCode;
import org.chromium.device.AppLauncherApplicationInfo;
...
public class AppLauncherManagerImpl implements AppLauncherManager {
	 ...
	 */
	public static class Factory implements InterfaceFactory<AppLauncherManager> {
			private Context mContext;
			...
			public AppLauncherManager createImpl() {
					return new AppLauncherManagerImpl(mContext);
			}
	}
